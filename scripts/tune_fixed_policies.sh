...
python tune.py -f ../hyperpars/noisy_obs/long-fixed/fixed_policy_UM1.yml 
python tune.py -f ../hyperpars/noisy_obs/long-fixed/fixed_policy_UM2.yml 
python tune.py -f ../hyperpars/noisy_obs/long-fixed/fixed_policy_UM3.yml 
